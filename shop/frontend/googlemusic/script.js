...
// ══════════════════ GOOGLEMUSIC PAGE ══════════════════
const FALLBACK_PRODUCTS = [{"emoji": "🎸", "name": "Acoustic Guitar Beginner Pack", "price": 3499, "original": 5999, "rating": 4.5, "reviews": 2600, "badge": "deal", "off": 42}, {"emoji": "🎹", "name": "Casio CT-S300 61-Key Portable Keyboard", "price": 10999, "original": 13999, "rating": 4.6, "reviews": 1400, "badge": "new", "off": 21}, {"emoji": "🥁", "name": "Electronic Drum Practice Pad Set", "price": 4999, "original": 7999, "rating": 4.3, "reviews": 900, "badge": "", "off": 37}, {"emoji": "🎤", "name": "USB Condenser Microphone Studio Kit", "price": 3299, "original": 4999, "rating": 4.5, "reviews": 3100, "badge": "deal", "off": 34}, {"emoji": "🎻", "name": "Student Violin 4/4 Full Size with Case", "price": 6499, "original": 8999, "rating": 4.2, "reviews": 560, "badge": "", "off": 28}];

async function renderProducts() {
  const grid = document.getElementById('productsGrid');
  const products = await fetchProducts('googlemusic', FALLBACK_PRODUCTS);
  if (!products.length) {
