...
// ══════════════════ GOOGLECLOTHES PAGE ══════════════════
const FALLBACK_PRODUCTS = [{"emoji": "👕", "name": "Men's Cotton T-Shirt Pack of 5", "price": 799, "original": 1499, "rating": 4.2, "reviews": 22000, "badge": "deal", "off": 47}, {"emoji": "👗", "name": "Women's Floral Summer Dress", "price": 1299, "original": 2499, "rating": 4.4, "reviews": 5400, "badge": "new", "off": 48}, {"emoji": "👟", "name": "Nike Air Max 270 Running Shoes", "price": 5999, "original": 14999, "rating": 4.6, "reviews": 9800, "badge": "deal", "off": 60}, {"emoji": "🧥", "name": "Men's Winter Bomber Jacket", "price": 2199, "original": 3999, "rating": 4.3, "reviews": 3100, "badge": "", "off": 45}, {"emoji": "👜", "name": "Women's Leather Handbag", "price": 1899, "original": 3499, "rating": 4.5, "reviews": 2700, "badge": "prime", "off": 46}];

async function renderProducts() {
  const grid = document.getElementById('productsGrid');
  const products = await fetchProducts('googleclothes', FALLBACK_PRODUCTS);
  if (!products.length) {
...
// INIT
(async function init() {
  await renderShell('googleclothes');
  renderFooter();
  await renderCartDrawer();
  renderProducts();
})();
