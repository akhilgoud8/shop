...
// ══════════════════ GOOGLEGROCERY PAGE ══════════════════
const FALLBACK_PRODUCTS = [{"emoji": "🌾", "name": "Basmati Rice 5kg Premium Aged", "price": 549, "original": 699, "rating": 4.5, "reviews": 8700, "badge": "", "off": 21}, {"emoji": "🫒", "name": "Extra Virgin Olive Oil 1L", "price": 899, "original": 1199, "rating": 4.6, "reviews": 3200, "badge": "new", "off": 25}, {"emoji": "🍫", "name": "Assorted Chocolate Gift Box", "price": 499, "original": 799, "rating": 4.7, "reviews": 6100, "badge": "deal", "off": 38}, {"emoji": "☕", "name": "Arabica Coffee Beans 500g", "price": 649, "original": 899, "rating": 4.4, "reviews": 4300, "badge": "", "off": 28}, {"emoji": "🌱", "name": "Indoor Plant Combo Set of 4", "price": 599, "original": 999, "rating": 4.3, "reviews": 1900, "badge": "prime", "off": 40}];

async function renderProducts() {
  const grid = document.getElementById('productsGrid');
  const products = await fetchProducts('googlegrocery', FALLBACK_PRODUCTS);
  if (!products.length) {
...
// INIT
(async function init() {
  await renderShell('googlegrocery');
  renderFooter();
  await renderCartDrawer();
  renderProducts();
})();
